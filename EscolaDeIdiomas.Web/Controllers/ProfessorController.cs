...
namespace EscolaDeIdiomas.Web.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        public ProfessorController(EscolaDeIdiomasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CPF,Telefone")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CPF,Telefone")] Professor professor)
        {
            if (id != professor.Id)
            {
                return NotFound();
